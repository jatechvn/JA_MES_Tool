...
class DynamicIslandCapsule extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final effectiveText = mainText ?? statusText ?? '';
    final activeColor = statusColor ?? customColor ?? colors.accentEmerald;
            ...
            children: [
              ...
              ConstrainedBox(
                ...
                child: AsymmetricMarqueeText(
                  text: effectiveText,
                  style: TextStyle(
                    color: isRunning || statusColor != null
                        ? activeColor
                        : colors.textMuted,
                    fontSize: 11,
...
class _TopBarExpandingButtonState extends State<TopBarExpandingButton> {
  ...
  Widget _buildIcon(AppColors colors) {
    final effectiveColor =
        widget.textColor ?? widget.accentColor ?? colors.accentCyan;
    if (widget.icon is IconData) {
      return Icon(widget.icon as IconData, size: 14, color: effectiveColor);
  ...
  Widget build(BuildContext context) {
    ...
    final currentLabel = _isHovered
        ...
        : (widget.collapsedLabel ??
              (widget.label != null && !widget.isCompact ? widget.label! : ''));
