...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.5.3-blue.svg" alt="Version 2.5.3">
...
│       ├── constants.dart         # Global app constants & defaults (v2.5.3)
...
├── pubspec.yaml                   # Flutter package manifest (v2.5.3+6)
