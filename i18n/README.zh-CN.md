...
<p align="center">
  <img src="https://img.shields.io/badge/banben-2.9.2-blue.svg" alt="版本 2.9.2">
...
│   │   ├── constants.dart         # 全局常量与默认配置 (v2.9.2)
...
├── pubspec.yaml                   # Flutter 包配置文件 (v2.9.2+16)
├── ABOUT.txt                      # 项目卡片
├── CHANGELOG.md                   # 完整版本历史
└── LICENSE                        # 许可证文件
```
