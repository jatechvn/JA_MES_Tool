...
<p align="center">
  <img src="https://img.shields.io/badge/banben-2.10.0-blue.svg" alt="版本 2.10.0">
...
首次启动且 `config.json` 中没有保存 `"lang"` 时，应用会按 Windows locale 选择默认语言：越南语环境使用 `vi`，中文环境使用 `cn`，其他环境使用 `en`。
