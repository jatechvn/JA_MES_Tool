...
<p align="center">
  <img src="https://img.shields.io/badge/phien_ban-2.5.2-blue.svg" alt="Phiên bản 2.5.2">
...
│       ├── constants.dart         # Hằng số toàn cục & Cấu hình mặc định (v2.5.2)
...
├── pubspec.yaml                   # File cấu hình Flutter (v2.5.2+5)
